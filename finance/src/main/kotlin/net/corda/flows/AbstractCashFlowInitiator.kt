 ...
 */
abstract class AbstractCashFlowInitiator(override val progressTracker: ProgressTracker) : FlowLogic<SignedTransaction>() {
    companion object {
        object GENERATING_ID : ProgressTracker.Step("Generating transaction identities")
